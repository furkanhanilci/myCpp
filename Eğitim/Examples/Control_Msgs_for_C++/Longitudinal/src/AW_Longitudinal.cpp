...
class MinimalSubscriber : public rclcpp::Node
{
  public:
    ...
    {
      RCLCPP_INFO(this->get_logger(), "Recieved - Speed : '%f', Acceleration : '%f'", message->longitudinal.speed, message->longitudinal.acceleration);
      //cout << message->speed << message->acceleration << endl;
